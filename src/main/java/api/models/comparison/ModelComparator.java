...
public class ModelComparator {
    ...
    public static <A, B> ComparisonResult compareFields(A request, B response, Map<String, String> fieldMappings){
        ...
        for (Map.Entry<String, String> entry : fieldMappings.entrySet()) {
            ...
            Object value2 = getFieldValue(response, responseValue);

            if (!Objects.equals(String.valueOf(value1), String.valueOf(value2))) {
                mismatches.add(new ComparisonResult.Mismatch(requestField + " -> " + responseValue, value1, value2));
            }
        }
    ...
    public static class ComparisonResult {
        ...
        public ComparisonResult(List<Mismatch> mismatches){this.mismatches = mismatches;}

        public boolean isSuccess() {return mismatches.isEmpty();}
